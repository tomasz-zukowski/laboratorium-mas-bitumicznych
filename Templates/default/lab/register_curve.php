        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6">
                            <i class="fa fa-line-chart"></i> Rejestracja krzywej uzniernienia mieszanki <a><?php echo $this->get('info','symbol'); ?></a>
                        </div>
                        <div class="col-sm-6 text-right">
                            <?php
                            if(Permissions::checkPermission('lab_examination_type'))
                            {
                                echo '<a href="/lab/examination_type/'.$this->get('info','id').'"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-left"></i> powrót</button></a> ';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="<?php echo $_this_path; ?>">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <label>Data rejestracji krzywej</label>
