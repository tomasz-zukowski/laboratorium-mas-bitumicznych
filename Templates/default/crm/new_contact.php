        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6">
                            <i class="fa fa-plus"></i> Rejestracja nowego kontaktu
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','description','class'); ?>">
                                                <textarea class="form-control" name="description" placeholder="Opis rejestrowanego kontaktu. Imię, nazwisko itp.." required autofocus><?php echo (isset($_POST['description'])) ? $_POST['description'] : ""; ?></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group form-inline <?php echo $this->get('form_errors','phone','class'); ?>">
                                                ...
                                                <input class="form-control" type="text" name="phone" style="width: 100%;" value="<?php echo (isset($_POST['phone'])) ? $_POST['phone'] : ""; ?>" placeholder="Numer telefonu" maxlength="100" />
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group form-inline <?php echo $this->get('form_errors','email','class'); ?>">
                                                ...
                                                <input class="form-control" type="email" name="email" style="width: 100%;" value="<?php echo (isset($_POST['email'])) ? $_POST['email'] : ""; ?>" placeholder="Adres e-mail" maxlength="100" />
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','comments','class'); ?>">
                                                <textarea class="form-control" name="comments" placeholder="Uwagi"><?php echo (isset($_POST['comments'])) ? $_POST['comments'] : ""; ?></textarea>
