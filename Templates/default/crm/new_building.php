        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6">
                            <i class="fa fa-plus"></i> Rejestracja nowej budowy
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','name','class'); ?>">
                                                <input class="form-control" type="text" name="name" value="<?php echo (isset($_POST['name'])) ? $_POST['name'] : ""; ?>" placeholder="Nazwa budowy" maxlength="100" required autofocus />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','comments','class'); ?>">
                                                <textarea class="form-control" name="comments" placeholder="Uwagi dotyczące budowy"><?php echo (isset($_POST['comments'])) ? $_POST['comments'] : ""; ?></textarea>
