        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-6">
                            <i class="fa fa-plus"></i> Rejestracja nowego klienta
                        </div>
                        <div class="col-sm-6 text-right">
                            <a href="/crm/review"><button class="btn btn-xs btn-info"><i class="fa fa-arrow-left"></i> powrót</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','name','class'); ?>">
                                                <input class="form-control" type="text" name="name" value="<?php echo (isset($_POST['name'])) ? $_POST['name'] : ""; ?>" placeholder="Krótka nazwa klienta" maxlength="100" required autofocus />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','name2','class'); ?>">
                                                <input class="form-control" type="text" name="name2" value="<?php echo (isset($_POST['name2'])) ? $_POST['name2'] : ""; ?>" placeholder="Pełna nazwa klienta" maxlength="255" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group form-inline <?php echo $this->get('form_errors','address','class'); ?>">
                                                ...
                                                <input class="form-control" type="text" name="street" id="street" style="width: 50%;" value="<?php echo (isset($_POST['street'])) ? $_POST['street'] : ""; ?>" placeholder="Nazwa ulicy" maxlength="100" required />
                                                <input class="form-control" type="text" name="number" id="number" style="width: 24%;" value="<?php echo (isset($_POST['number'])) ? $_POST['number'] : ""; ?>" placeholder="Numer" maxlength="15" required />
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group form-inline <?php echo $this->get('form_errors','address2','class'); ?>">
                                                <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
                                                <input class="form-control" type="text" name="post_code" id="post_code" onchange="codeAddress()" style="width: 30%" value="<?php echo (isset($_POST['post_code'])) ? $_POST['post_code'] : ""; ?>" placeholder="Kod pocztowy" maxlength="10" required />
                                                <input class="form-control" type="text" name="city" id="city" onchange="codeAddress()" style="width: 69%;" value="<?php echo (isset($_POST['city'])) ? $_POST['city'] : ""; ?>" placeholder="Miejscowość" maxlength="100" required />
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','country','class'); ?>">
                                                <input class="form-control" type="text" name="country" value="<?php echo (isset($_POST['country'])) ? $_POST['country'] : ""; ?>" placeholder="Kraj pochodzenia" maxlength="100" required />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','nip','class'); ?>">
                                                <input class="form-control" type="text" name="nip" value="<?php echo (isset($_POST['nip'])) ? $_POST['nip'] : ""; ?>" placeholder="Numer NIP" maxlength="10" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','eunip','class'); ?>">
                                                <input class="form-control" type="text" name="eunip" value="<?php echo (isset($_POST['eunip'])) ? $_POST['eunip'] : ""; ?>" placeholder="Europejski numer NIP" maxlength="15" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group <?php echo $this->get('form_errors','activity_description','class'); ?>">
                                                <textarea class="form-control" name="activity_description" placeholder="Opis działalności"><?php echo (isset($_POST['activity_description'])) ? $_POST['activity_description'] : ""; ?></textarea>
